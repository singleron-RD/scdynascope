...
import utils
from __init__ import ASSAY,FEATURE_FILE_NAME,BARCODE_FILE_NAME,MATRIX_FILE_NAME
...
class Labeled:
    ...
    def dataframe_to_matrix(self, df, features, barcodes, barcode_column='Barcode', feature_column='geneID', value='UMI'):
        ...
        mtx = scipy.sparse.coo_matrix((df_grouped[value], (gene_id_codes, barcode_codes)),
...
def get_opts_labeled():
    ...
    parser.add_argument('--bg_snp', nargs='+', required=False,
