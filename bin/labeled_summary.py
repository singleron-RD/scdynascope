...
def get_opts_labeled_summary():
    ...
    parser.add_argument(
        "--min_cells", help="min cell number to call a gene's tor", type=int, default=10, required=False
    )
    parser.add_argument(
        "--min_genes", help="min gene number to call a cell's tor", type=int, default=10, required=False
    )
